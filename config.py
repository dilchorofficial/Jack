...
# ----------------------------------------------------------------
# ----------------------------------------------------------------
SOURCE = getenv("SOURCE", "https://github.com/dilchorofficial/Jack")
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/ll_botchat_ll")
CHAT = getenv("CHAT", "https://t.me/+PQ9Ua7Vm_zowODY9")
# ------------------------------------------------------------------------------
# -------------------------------------------------------------------------------
...
STREAMI_PICS = [
"https://files.catbox.moe/5aq04y.mp4",
"https://files.catbox.moe/k1dv48.mp4",

]

START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/5aq04y.mp4"
)

HELP_IMG_URL = getenv(
    "HELP_IMG_URL", "https://files.catbox.moe/4w7maj.jpg"
)
